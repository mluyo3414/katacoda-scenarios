...
Take a look at the information provided after running this command (in this case it contains the command to get the password for the UI - look under `NOTES`). This information is also available running:
